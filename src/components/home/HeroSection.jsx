...
const SHOWCASE_DISHES = [
  {
    id: "thc-01",
    tag: "CHEF'S SPECIAL SIZZLER",
    badge: "Bestseller",
    name: "THC Grand Highway Sizzler",
    price: 449,
    rating: "4.9",
    reviews: "2.4k+ reviews",
    prepTime: "15 mins",
    image: "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?auto=format&fit=crop&w=800&q=80",
    description: "Smokey tandoori kebabs, crispy butter naan bites and mountain herb rice cooked over charcoal flame.",
    accentColor: "from-amber-500/20 via-orange-500/10 to-transparent",
    badgeColor: "bg-amber-400 text-slate-950"
  },
  {
    id: "thc-04",
    tag: "HILL STATION FAVORITE",
    badge: "Most Loved",
    name: "Mussoorie Road Butter Maggi",
    price: 139,
    rating: "5.0",
    reviews: "3.1k+ reviews",
    prepTime: "8 mins",
    image: "https://images.unsplash.com/photo-1612927601601-6638404737ce?auto=format&fit=crop&w=800&q=80",
    description: "Double-tadka hill station Maggi with crunchy mountain veggies, green chillies & generous melting Amul butter.",
    accentColor: "from-yellow-500/20 via-amber-500/10 to-transparent",
    badgeColor: "bg-yellow-400 text-slate-950"
  },
  {
    id: "thc-06",
    tag: "TRUCKER'S HEAVY BITE",
    badge: "Crowd Choice",
    name: "18-Wheeler Monster Burger",
    price: 279,
    rating: "4.8",
    reviews: "1.8k+ reviews",
    prepTime: "12 mins",
    image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?auto=format&fit=crop&w=800&q=80",
    description: "Double crispy patty, molten cheddar blanket, caramelized onions & secret highway peri-peri smokey glaze.",
    accentColor: "from-rose-500/20 via-orange-500/10 to-transparent",
    badgeColor: "bg-rose-500 text-white"
  },
  {
    id: "thc-07",
    tag: "SMOKY CLAY AROMA",
    badge: "Must Try",
    name: "Doon Valley Kulhad Chai",
    price: 49,
    rating: "5.0",
    reviews: "4.5k+ reviews",
    prepTime: "5 mins",
    image: "https://images.unsplash.com/photo-1576092768241-dec231879fc3?auto=format&fit=crop&w=800&q=80",
    description: "Slow-brewed fragrant elaichi and adrak chai served in smoking hot traditional earthenware kulhad.",
    accentColor: "from-orange-500/20 via-amber-500/10 to-transparent",
    badgeColor: "bg-amber-400 text-slate-950"
  },
  {
    id: "thc-02",
    tag: "VEG SIZZLING DELIGHT",
    badge: "Chef Pick",
    ...
    description: "Charcoal grilled malai paneer cubes, tossed Himalayan peppers, herbed rice & sizzling tandoori sauce.",
