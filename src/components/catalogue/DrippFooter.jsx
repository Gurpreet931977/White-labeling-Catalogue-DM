...
import { Sparkles, ArrowUpRight, Heart, Coffee, Globe, Phone, Mail } from 'lucide-react';
import { CATALOGUE_DATA } from '../../data/catalogueData';
import { sounds } from '../../utils/audio';

export function DrippFooter({ onLaunchCafeDemo, onOpenCustomizer, onOpenQuote }) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs font-clash text-slate-300">
              <li>
                <button 
                  onClick={() => { sounds.playClick(); onLaunchCafeDemo(); }}
                  className="hover:text-amber-400 flex items-center gap-1.5 transition text-left"
                >
                  <Coffee className="w-3.5 h-3.5 text-amber-400" />
                  <span>Cafes &amp; Restaurants (Active Demo)</span>
                </button>
              </li>
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <div className="space-y-2 text-xs font-clash">
              <button
                ...
                className="w-full btn-dripp-primary py-2.5 px-4 rounded-full font-bold flex items-center justify-center gap-2 cursor-pointer shadow-lg"
              >
              ...
              <button
                ...
                className="w-full btn-dripp-secondary py-2.5 px-4 rounded-full font-semibold flex items-center justify-center gap-2 cursor-pointer"
              >
