  ...
  niches: [
    {
      ...
      headline: "6 Turnkey Operating Models: Table QR, Self-Serve, Delivery & Loyalty Club",
      description: "Complete restaurant operating suite with 6 selectable architectures: Table QR POS, Self-Serve Counter QSR, Brand Showcase Landing Page, Direct Online Delivery, Hybrid Dine-In & Delivery, and 7-Visit Loyalty Rewards Club.",
      accentColor: "#ebd73f",
      glowClass: "ambient-glow-yellow",
      cardType: "live-app",
      metrics: {
        highlightNum: "6 Models",
        highlightLabel: "Turnkey Architectures",
        retentionNum: "99.4%",
        retentionLabel: "Order Accuracy",
        loadSpeed: "0.28s",
      },
      tags: ["6 Operating Models", "Table QR & Self-Serve", "Direct Online Delivery", "7-Visit Loyalty Club", "Kitchen POS"],
      features: [
